	...
	return (
		<List className={classes.drawerList}>
			...
			>
				...
				<ListItemText primary={__('General', 'kaliforms')} />
			</ListItem>
			<ListItem
				button
			...
			>
				...
				<ListItemText primary={__('Form styling', 'kaliforms')} />
			</ListItem>
			<ListItem
				button
			...
			>
				...
				<ListItemText primary={__('Spam protection', 'kaliforms')} />
			</ListItem>
			<ListItem
				button
			...
			>
				...
				<ListItemText primary={__('Integrations', 'kaliforms')} />
			</ListItem>
			<If condition={typeof KaliFormsObject.userRegistrationInstalled !== 'undefined'}>
				...
				>
					...
					<ListItemText primary={__('User registration', 'kaliforms')} />
				</ListItem>
			</If>
			<If condition={typeof KaliFormsObject.userRegistrationInstalled === 'undefined'}>
				<ListItem
			...
			<If condition={typeof KaliFormsObject.conditionalLogic !== 'undefined'}>
				...
				>
					...
					<ListItemText primary={__('Conditional logic', 'kaliforms')} />
				</ListItem>
				<ListItem
					button
				...
				>
					...
					<ListItemText primary={__('Calculator', 'kaliforms')} />
				</ListItem>
				<ListItem
					button
				...
				>
					...
					<ListItemText primary={__('Custom CSS', 'kaliforms')} />
				</ListItem>
				<ListItem
					button
				...
				>
					...
					<ListItemText primary={__('Custom JS', 'kaliforms')} />
				</ListItem>
				<ListItem
					button
				...
				>
					...
					<ListItemText primary={__('Custom PHP', 'kaliforms')} />
				</ListItem>
			</If>
			...
			<If condition={typeof KaliFormsObject.newsletterInstalled !== 'undefined'}>
				<ListItem
					...
					<ListItemText primary={__('Newsletter', 'kaliforms')} />
				</ListItem>
			</If>
			<If condition={typeof KaliFormsObject.newsletterInstalled === 'undefined'}>
				<ListItem
